...
short_description: "Owing to tremendous advancements in machine learning and other technology chatbots have the year"
draft: false
image: "/assets/imgs/service/pd/items/service-1.jpg"
category: "Design"
feature:
  - "UI/UX Design"
  - "Research"
    ...
    - name: "Styling"
      content:
        - type: "only-text"
          text: "Masked and socially distant, I walked a mile in their shoes through the dairy, pet food, and freezer aisles. This single visit uncovered many insights that had not come up in the video team."
        - type: "only-image"
          image: "/assets/imgs/service/pd/details/service-1-d.jpg"
    - name: "Review"
      content:
        - type: "only-text"
